...
from utils.utils import print_rank_0, to_device, save_hf_format, set_random_seed, get_all_reduce_mean, get_optimizer_grouped_parameters, save_zero_three_model, load_hf_tokenizer,DataCollator
...
def main():
    ...
    model = create_hf_model(AutoModelForCausalLM,
                            ...
                            tokenizer,
                            ds_config,
                            disable_dropout=args.disable_dropout,device = args.local_rank)
